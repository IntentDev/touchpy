...
class Example:
	def __init__(self, stage, num_frames=10, res=[32, 64, 16], quiet=False):
	...
	def step(self):
		...
		with wp.ScopedTimer(f"simulate frame {self.current_frame}", print=False, active=True):
	...
	def on_frame(comp, this):
		...
		this.step()
		y = this.state_0.particle_q.reshape((512, 432))
...
if __name__ == "__main__":
	...
	example = Example(stage_path, quiet=True)
