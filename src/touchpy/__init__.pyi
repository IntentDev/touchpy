...
def init_logging(level: LogLevel = LogLevel.DEBUG, console: bool = True, file: bool = False) -> None:
    """
...
def get_dlpack_capsule_info(array: NDArray) -> dict:
    """
...
class Comp:
    ...
    @overload
    def __init__(self, flags: CompFlags = 37, fps: float = 60, device: int = 0, td_path: str = '') -> None: ...

    @overload
    def __init__(self, tox_path: str, flags: CompFlags = 37, fps: float = 60, device: int = 0, td_path: str = '') -> None: ...

    def load(self, tox_path: str, fps: float = 60) -> None:
        """
    ...
    @overload
    def start_next_frame(self) -> bool:
        """
    ...
    @overload
    def start_next_frame(self, seconds: float) -> bool: ...

    @overload
    def start_next_frame(self, time_value: int, time_scale: int) -> bool: ...
    ...
    @overload
    def set_on_loaded_callback(self, callback: Callable) -> None: ...
    ...
    @overload
    def set_on_unloaded_callback(self, callback: Callable) -> None: ...
    ...
    @overload
    def set_on_layout_change_callback(self, callback: Callable) -> None: ...

class CudaFlags(enum.Flag):
    NONE = 0
...
class OutTop:
    ...
    def as_dlpack(self, sync_cuda_stream: bool = False) -> NDArray: ...

    def as_tensor(self, sync_cuda_stream: bool = False) -> NDArray: ...
...
class InTop:
    ...
    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(4, None, None), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(3, None, None), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(2, None, None), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(1, None, None), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(None, None, 4), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(None, None, 3), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(None, None, 2), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(None, None, 1), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(4, None, None), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(3, None, None), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(2, None, None), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(1, None, None), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(None, None, 4), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(None, None, 3), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(None, None, 2), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_dlpack(self, array: Annotated[NDArray, dict(shape=(None, None, 1), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(4, None, None), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(3, None, None), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(2, None, None), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(1, None, None), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(None, None, 4), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(None, None, 3), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(None, None, 2), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(None, None, 1), device='cuda')], flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(4, None, None), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(3, None, None), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(2, None, None), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(1, None, None), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(None, None, 4), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(None, None, 3), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(None, None, 2), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...

    @overload
    def from_tensor(self, array: Annotated[NDArray, dict(shape=(None, None, 1), device='cuda')], stream: int, flags: CudaFlags = CudaFlags.NONE) -> None: ...
...
class ChopChannels:
    ...
    @overload
    def __init__(self, array: Annotated[NDArray[numpy.float32], dict(shape=(None, None), device='cpu')], rate: float = -1.0, is_time_dependent: bool = False, start_time: int = 0, end_time: int = 0, channel_names: Sequence[str] = []) -> None: ...
    ...
    @overload
    def __getitem__(self, name: str) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), device='cpu')]:
        """Returns the channel by name."""

    @overload
    def __getitem__(self, index: int) -> Annotated[NDArray[numpy.float32], dict(shape=(None,), device='cpu')]:
    ...
    def as_numpy(self) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), writable=False)]:
        """
    ...
    def as_numpy_ref(self) -> Annotated[NDArray[numpy.float32], dict(shape=(None, None), writable=False)]:
        """
    ...
    def from_numpy(self, arg0: Annotated[NDArray[numpy.float32], dict(shape=(None, None), device='cpu')], arg1: float, arg2: bool, arg3: int, arg4: int, arg5: Sequence[str], /) -> None: ...
